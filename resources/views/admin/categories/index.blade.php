<x-app-layout>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title"><i class="fa fa-list"></i> @lang('locale.category', ['suffix'=>app()->getLocale() == 'en' ? 'ies' : 's', 'prefix'=>''])</h4>
                                </div>
                                <div class="col-md-6">
                                    <a class="btn btn-success btn-icon" style="float: right" data-target="#create-category" data-toggle="modal">
                                ...
                                <div class="col-12">
                                    <table cellspacing="0" class="table table-striped" id="order-listing" width="100%">
                                        <thead>
                                            ...
                                            <th>@lang('locale.name') @lang('locale.category', ['suffix'=>app()->getLocale() == 'en' ? 'y' : '', 'prefix'=>''])</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="display: inline-block">
                                                        <a class="btn btn-primary" data-target="#edit-category{{ $item->id }}" data-toggle="modal">
    ...
    <x-create-category></x-create-category>
    @push('scripts')
