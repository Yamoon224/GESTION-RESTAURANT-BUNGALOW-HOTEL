<x-app-layout>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title"><i class="fa fa-utensils"></i> @lang('locale.product', ['suffix'=>'s', 'prefix'=>''])</h4>
                                </div>
                                <div class="col-md-6">
                                    <a class="btn btn-success btn-icon" style="float: right" data-target="#create-product" data-toggle="modal">
                                    ...
                                    <table cellspacing="0" class="table table-striped" id="order-listing" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $item->name }}</td>
                                                <td>{{ $item->qty." ".$item->category->name }}</td>
                                                ...
                                                <td>
                                                    <div style="display: inline-block">
                                                        ...
                                                        <a class="btn btn-warning" href="{{ route('products.show', $item->id) }}">
                                                            <i class="typcn icon typcn-eye"></i>
                                                        </a>
                                                    </div>
                                                    <form action="{{ route('products.destroy', $item->id) }}" style="display: inline-block" method="post">
                                                        @csrf
                                                        @method('DELETE')
    ...
    <x-create-product :categories="$categories" :ingredients="$ingredients"></x-create-product>
    @push('scripts')
